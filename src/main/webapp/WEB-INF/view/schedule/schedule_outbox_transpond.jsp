...
function outboxcloseAjaxDone(json) {
	DWZ.ajaxDone(json);
	// 模拟触发导航管理菜单按钮
	navTab.openTab("outboxId",
			"${ctx}/schedule/outbox/list", {
				title : "发件箱",
				fresh : true,
				data : {}
			});
	...
	function outboxsaveAsDraft() {
		$("input[type=hidden][name=flag]").val("1");
		submitForm();
	}
</script>
<div class="pageContent">
	<form method="post" id="outboxForm"
		action="${ctx}/schedule/insert"
		class="pageForm required-validate" enctype="multipart/form-data"
		onsubmit="return iframeCallback(this,outboxcloseAjaxDone)">
		...
		<div id="outbox_contacts" style="display: block;position: absolute;width: 200px;min-height: 200px;max-height:600px; left: 800px;top: 30px;border: 1px solid rgb(153,187,232);overflow: hidden;">
		...
		<div class="formBar">
			<ul>
				<li><a class="button" href="javascript:void(0)"
					onclick="outboxsaveAsDraft()"><span>保存为草稿</span></a>
				</li>
				<li><a class="button" href="javascript:void(0)"
					onclick="outboxsubmitForm()"><span>发送邮件</span></a>
				</li>
				<li><div class="button">
				...
				<li><a class="button"
					...
					target="ajax" rel="outbox"><span>取消</span></a></li>
			</ul>
		</div>
	</form>
</div>